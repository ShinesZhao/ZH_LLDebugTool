...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "UIBarButtonItem adapter"
  ...
  spec.homepage     = "https://github.com/ShinesZhao/ZH_LLDebugTool.git"
  ...
  # spec.authors            = { "User" => "472059581@qq.com" }
  ...
  spec.source_files  = "ZH_LLDebugTool/Core/**/*.{h,m}","ZH_LLDebugTool/DebugTool/**/*.{h,m}"
